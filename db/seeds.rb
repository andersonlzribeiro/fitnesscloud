...
BillingPlan.create(description: "Mensal", days: 30)
BillingPlan.create(description: "Trimestral", days: 90)
BillingPlan.create(description: "Semestral", days: 180)
BillingPlan.create(description: "Anual", days: 365)
